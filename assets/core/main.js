/**
 * Project name: moodoo magic
 * Version: 1.1.2
 * Author: moe.wong
 * Wechat: skywooooo
 * Email: skysmile@gmail.com
 */
...
*/ 
var colors = [
    {name:"油菜花田",   line0txt:"#000000",   line1bg:"#f2e849",  line1txt:"#2757da",     line2bg:"#2757da",    line2txt:"#ffffff"},
    {name:"7+7",        line1bg:"#00805f",  line1txt:"#ffffff",     line2bg:"#febd00",    line2txt:"#e70000"},
    {name:"不焦绿",     line1bg:"#3bb778",    line1txt:"#ffffff",   line2bg:"#d2f4fe",     line2txt:"#3bb778"},
    ...
    {name:"贴心备胎",   line1bg:"#fe50a7",    line1txt:"#ffffff",    line2bg:"#e1ffb9",     line2txt:"#39ad00"},
    ...
    {name:"萌萌同款",   line1bg:"#153273",    line1txt:"#ffffff",    line2bg:"#e1ffb9",     line2txt:"#143273"},
]
...
function setAvatar(objColor){
    $(".line0").html($("#area").val());
    $(".line0").css("color",objColor.line0txt ? objColor.line0txt : objColor.line2bg);
